...
ALL_PRECISIONS_REPQ = ['32_32_32', '8_8_8', '4_8_8', '6_6_6', '8_4_4', '4_4_4']

# ************************************************************************
# Examine error deltas between precisions

# settings = {
#     'model': ALL_MODELS,
#     'precision': ['8_8_8', '4_8_8', '6_6_6', '8_4_4', '4_4_4'], #, '8_4_32'], #, '4_4_32'],
#     'method': ['repqvit'] #, 'iasvit'] #, 'fqvit']
# }

# exp.tabulate_precision_error_diffs(settings)

# settings['method'] = ['iasvit']
# exp.tabulate_precision_error_diffs(settings)
...
# exp.plot_acc_vs_confidence_thr(
#     settings, 
#     save_file='acc_vs_conf_MODEL_all_METHOD_iasvit', 
#     size=(16,3),
#     save_fmt='png',
#     conf_lim=[0.0,0.90],
#     acc_lim=[0.0,0.60]
...
# settings['model'] = ['deit_small_patch16_224', 'vit_small_patch16_224', 'swin_small_patch4_window7_224']
# exp.plot_acc_vs_confidence_thr(
#     settings, 
#     save_file='acc_vs_conf_MODEL_small_METHOD_repqvit', 
#     size=(10,3),
#     save_fmt='png',
#     conf_lim=[0.0,0.90],
#     acc_lim=[0.0,0.60]
...
#                     dataset='ImageNet-A',
#                     save_file='ImageNet-A_rra_MODEL_all_METHOD_repqvit_useTS',
#                     save_fmt='png',
#                     size=(12,2.2),
#                     acc_lim=[0,60]
#                 )
...
#     'precision': ['32_32_32', '8_8_32', '8_8_8', '4_8_8'], #'6_6_32', '4_8_32'], #, '4_4_32'],
#     'method': ['float', 'fqvit']
# }
...
# exp.plot_entropy_histograms(settings,
#                     col_setting='model',
#                     save_file=f'entropy_kde_MODELS_small_METHOD_repqvit_commonnorm_0',
#                     size=(9,5),
#                     save_fmt='png',
#                     y_lim_known=[0,0.6],
#                     y_lim_unknown=[0,0.6]
...
# exp.plot_entropy_histograms(settings,
#                     col_setting='model',
#                     save_file=f'entropy_kde_MODELS_all_METHOD_repqvit_commonnorm_0',
#                     size=(15,5),
#                     save_fmt='png',
#                     y_lim_known=[0,0.6],
#                     y_lim_unknown=[0,0.6]
...
#                         )
settings['logits_RC'] = 1 
exp.plot_reliability_curve(    
                            settings, 
                            save_file='small_arch_repqvit_reliability_diagrams_RC',
                            size=(7.2, 6),
                            save_fmt='png'
                        )
...
# print("...for small variants quantized on RepQ-ViT, ImageNet-A")
# settings['logits_RC'] = 1 
# exp.plot_reliability_curve(    
#                             settings, 
#                             save_file='small_arch_repqvit_reliability_diagrams_RC',
...
# }
# exp.plot_pareto_acc_vs_uncertainty(
#     settings,
#     save_file='pareto_acc_vs_uncertainty_METHOD_fqvit_extend_lim', 
#     save_fmt='png',
#     x_lim=[0.15,0.45], 
#     ece_lim=[0,0.25],
#     rbs_lim=[0.45,0.8]
...
# exp.plot_pareto_acc_vs_uncertainty(
#     settings, 
#     save_file='pareto_acc_vs_uncertainty_METHOD_repqvit_extend_lim', 
#     save_fmt='png',
#     x_lim=[0.15,0.45], 
#     ece_lim=[0,0.25], 
#     rbs_lim=[0.45,0.8]
...
# exp.plot_pareto_acc_vs_uncertainty(
#     settings,
#     save_file='pareto_acc_vs_uncertainty_METHOD_iasvit_extend_lim', 
#     save_fmt='png',
#     x_lim=[0.15,0.45], 
#     ece_lim=[0,0.25], 
#     rbs_lim=[0.45,0.8]
